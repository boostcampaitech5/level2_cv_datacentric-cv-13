...
def parse_args():
    ...
    parser.add_argument('--seed', type=list, default=13)
    parser.add_argument('--use_wandb', type=list, default=True)
...
def do_training(data_dir, model_dir, device, image_size, input_size, num_workers, batch_size,
                learning_rate, max_epoch, save_interval, ignore_tags, seed, use_wandb):
